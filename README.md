...
## Come funziona?
Minecraft utilizza i pacchetti di risorse per assegnare quei caratteri a diversi valori Unicode, che è il modo in cui Minecarft ti consente di digitare in chat e scrivere sui segni ecc... Poiché i caratteri sono solo trame in un pacchetto di risorse, consente anche al gioco di aggiungere *emoji* che hanno i propri valori Unicode assegnati proprio come le lettere.

## Elenco di tutti i caratteri

|               Nome               |  Piattaforma | Carattere | Unicode |                     In Gioco                   |
|:--------------------------------:|:------------:|:---------:|:-------:|:----------------------------------------------:|
